...
import { getJobDetail, deleteJob, type JobDetailResponse } from '@/lib/apis/jobs';
...
export default function JobDetailPage() {
  ...
  const handleEdit = () => {
    router.push(`/buyer-dashboard/post-job?draft=${jobId}`);
  };
    ...
    return (
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='font-inter text-gray-600 mb-4'>The job you're looking for doesn't exist or you don't have permission to view it.</p>
